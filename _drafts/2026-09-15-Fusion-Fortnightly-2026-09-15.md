...
[Tokamak Energy completes a 14-month integrated HTS magnet test campaign on Demo4](https://tokamakenergy.com/2026/09/09/tokamak-energy-completes-world-leading-fusion-magnet-campaign-validating-technology-for-commercial-hts-systems/). Demo4 is comprised of 14 toroidal field coils and 2 poloidal field coils, an an attempt to make a a test of a sub-scale fusion-relevant set of magnets. It's an impressive achievement by the team. But, as a technology roadmapping aficionado, I question whether it was the right path to take. Was it better to do like Tokamak Energy did and build an integrated tokamak-like magnet configuration or was it better to do like CFS and build a single large magnet trying to match internally relevant parameters? I bet you know my opinion, but in the end time will tell.
...
[Fusion company Inertia, founded by the owner of The Onion, declares mass-production milestone after successfully making one thing faster](https://inertia.com/press/inertia-fast-fueling). Inertia says it has checked off its “fast fueling” milestone after showing that a deuterium-tritium ice layer can be formed in hours rather than days and simulations indicate it has sufficiently low roughness. The company has not yet demonstrated large-batch production or use of the targets.
